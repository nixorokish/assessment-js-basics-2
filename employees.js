...
/*  
    ...
    Create a method on the class called `getSchedule` that prints a string:
...
/*
    ...
    You can use this sample data or make up your own:
    name: Jess
    shifts: weekday mornings, weekday afternoons
*/

//CODE HERE
let empOne = new Employee(`Brenda`, `Mon-Wed 10:00-16:00`)
...
class Manager extends Employee {
    ...
    addEmployee(emp) {
        ...
        console.log(`\nSuccessfully added new employee under ${this.name}\n`)
    }
}


/*
    Create a new instance of your class. Save it to a variable called `manager`.
    You can use this sample data or make up your own:
    name: Winston
    shifts: weekday mornings, weekday afternoons
...
let manager = new Manager(`Chotchkie`, `Mon-Sat 11:00-14:00`, [`Brenda`, `Nick`])
